...
resource "aws_codebuild_project" "my_project" {
  name           = "projectbatchseven-tf"
  description    = "This code build project is created by terraform"
  build_timeout  = "60"
  queued_timeout = "480"

  service_role = "arn:aws:iam::686766985335:role/service-role/mycodebuildrole"
  ...
  source {
    type            = "CODECOMMIT"
    location        = "https://git-codecommit.us-east-1.amazonaws.com/v1/repos/codecommit-tf-batchseven"
    git_clone_depth = 1
...
resource "aws_codepipeline" "codepipeline" {
  ...
  stage {
    ...
    action {
      ...
      configuration = {
        ...
        "RepositoryName"       = "codecommit-tf-batchseven",
        "BranchName"           = "master",
  ...
  stage {
    ...
    action {
      ...
      configuration = {
        ClusterName = "my-batchsevencluster-tf",
        ServiceName = "mysvc",
